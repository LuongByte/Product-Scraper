...
class App:
    def __init__(self, base):
        ...
        self.label = Label(self.base, text='Deal Finder', font=('Arial', 40), relief='raised', bd='5', compound='top', image=self.test_img)
        self.search_frame = Frame(self.base)
        self.title_list = Listbox(self.base, font=('Arial', 15), background='white', height=15, width=100)
        self.entry = Entry(self.search_frame, font=('Arial', 40))
